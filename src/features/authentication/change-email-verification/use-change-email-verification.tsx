...
export const useChangeEmailVerification = () => {
  ...
  // const sendEmailAgain = (e:any, seconds:any, setMinutes:any , functionTimer:any , email:any) => {
  ...
  //     email
  //   }
  //   dispatch(resendEmailThunk({ userCredentials, navigate, axiosInstance, openAlert, setMinutes, functionTimer }))
